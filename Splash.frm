...
Begin VB.Form Splash 
   ...
   Begin VB.Label Label5 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Módulo de Gestion Comercial"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   12
         Charset         =   0
...
If Nulo_Valor0(PUB_FLAG) = 0 Then
  ...
  If wflag_bloq <> "A" Then
    MsgBox "Equipo: MicroProcesador No Identificado..." & Chr(13) & "- Esta copia del Ejecutable no procede - No tiene licencia de uso", vbCritical, "Proveedor del Software - Celular: 990901164"
    End
  End If
