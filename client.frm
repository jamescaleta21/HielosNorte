...
Begin VB.Form frmCLI 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "txtdepartamento"
      Tab(0).Control(1)=   "txtregpublico2"
      Tab(0).Control(2)=   "TxtLugarCasa"
      Tab(0).Control(3)=   "txtZonaNew"
      Tab(0).Control(4)=   "Txtdireccion"
      Tab(0).Control(5)=   "Txtnumdir"
      Tab(0).Control(6)=   "TxtZona"
      Tab(0).Control(7)=   "TxtSubZona"
      Tab(0).Control(8)=   "lblnom(37)"
      Tab(0).Control(9)=   "lblnom(22)"
      Tab(0).Control(10)=   "lblnom(31)"
      Tab(0).Control(11)=   "lblnom(11)"
      Tab(0).Control(12)=   "lblnom(10)"
      Tab(0).Control(13)=   "lblnom(9)"
      Tab(0).Control(14)=   "lblnom(6)"
      Tab(0).Control(15)=   "lblnom(7)"
      ...
      Tab(2).Control(10)=   "lblnom(20)"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "g_diasfac"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "LblDatos(20)"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "Label9"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "lblnom(19)"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).Control(15)=   "otrocontrato"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "letraotorgado"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "txtNucleo"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "txtDTX"
      Tab(2).Control(18).Enabled=   0   'False
      Tab(2).Control(19)=   "txtpordes"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "t_diascred"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "t_diasfac"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "t_fechafac"
      Tab(2).Control(22).Enabled=   0   'False
      Tab(2).Control(23)=   "txtprog"
      Tab(2).Control(23).Enabled=   0   'False
      Tab(2).Control(24)=   "txtautovaluo"
      Tab(2).Control(24).Enabled=   0   'False
      Tab(2).Control(25)=   "txtregpublico1"
      Tab(2).Control(25).Enabled=   0   'False
      Tab(2).Control(26)=   "copia"
      Tab(2).Control(26).Enabled=   0   'False
      Tab(2).Control(27)=   "ListBloqueos"
      Tab(2).Control(27).Enabled=   0   'False
      Tab(2).Control(28)=   "lisdescto"
      Tab(2).Control(28).Enabled=   0   'False
      Tab(2).Control(29)=   "txtpropiedad1"
...
'---------------------------------------------------------------
'(@#)1-A        JMENDOZA        20/12/2022   Implementación de Secuencia del vendedor
'*************************************************************************************
...
'AGREGADO GTS PARA VALIDAR POR DNI
...
Public Sub BLOQUEA_TEXT()
    ...
    Me.txtSecuencia.Enabled = False     '(@#)1-A
End Sub
Public Sub DESBLOQUEA_TEXT()
    ...
    Me.txtSecuencia.Enabled = True '(@#)1-A
End Sub
...
pub_cadena = "SELECT CLI_NOMBRE,CLI_RUC_ESPOSA FROM CLIENTES WHERE CLI_CODCIA = ? AND CLI_CP = ? AND CLI_RUC_ESPOSA = ? and CLI_CODCLIE <> ?  ORDER BY CLI_CODCLIE"
 Set PS_REP02 = CN.CreateQuery("", pub_cadena)
 PS_REP02.rdoParameters(0) = " "
 PS_REP02.rdoParameters(1) = " "
 PS_REP02.rdoParameters(2) = " "
 PS_REP02.rdoParameters(3) = 0
 ...
 If Left(CmbCGP.Text, 1) = "C" Then
  If frmCLI.txtRUCempresa.Text <> "" Then
    If Len(Trim(frmCLI.txtRUCempresa.Text)) <> 8 Then
       CONSIS_CLI = False
       MENSAJE_CLI "Nro.de D.N.I. No es Valido ..."
       txtRUCempresa.SetFocus
       GoTo ESCAPA
    End If
  End If
...
'CLI_CODCIA = ? AND CLI_CP = 'C' AND CLI_RUC_ESPOSO = ? and CLI_CODCLIE <> ?
 ...
 If Not llave_rep02.EOF Then
   MsgBox "DNI Existe en otro Cliente : " + Trim(llave_rep02!CLI_NOMBRE), 48, Pub_Titulo
    CONSIS_CLI = False
    Azul frmCLI.txtRUCesposa, frmCLI.txtRUCesposa
    GoTo ESCAPA
 End If
End If
...
'    WS_FILA = WS_FILA - 1
   ...
   ' frmCLI.txttelefono1.Text = Trim(xl.Cells(WS_FILA, 17))
   ' frmCLI.txtauto1.Text = Trim(xl.Cells(WS_FILA, 12))  ' DEPA
   ' frmCLI.txtauto2.Text = Trim(xl.Cells(WS_FILA, 13))  ' PROV
  '  frmCLI.txtregpublico1.Text = Trim(xl.Cells(WS_FILA, 14)) ' DIST
  '  frmCLI.txtregpublico2.Text = Trim(xl.Cells(WS_FILA, 3)) ' ZONA
   ' frmCLI.txtautovaluo.Text = Trim(xl.Cells(WS_FILA, 1)) ' DIA
    frmCLI.t_diasfac.Text = Trim(xl.Cells(WS_FILA, 5)) ' VENDEDOR
    'frmCLI.t_diascred.Text = Trim(xl.Cells(WS_FILA, 19)) ' TIPO NEGO
